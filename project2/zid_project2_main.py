...
print(
    f"The stock with the lowest average daily return in 2008: {min_avg_return_stock}，The average return: {min_avg_return:.4f}。")
...
print(
    f"The stock with the highest average monthly return in 2019: {max_avg_return_stock}，The average return: {max_avg_return:.4f}。")
...
print(f"The average monthly total volatility of TSLA in 2010: {tsla_avg_monthly_volatility:.4f}")
...
print(
    f"The ratio of the average monthly total volatility of the stock 'V' between 2008 and 2018: {volatility_ratio}")
